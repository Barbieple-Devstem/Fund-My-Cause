...
- [FmcClient](classes/FmcClient.md)
- [FmcContractError](classes/FmcContractError.md)
- [FmcRegistryClient](classes/FmcRegistryClient.md)

## Interfaces

- [CampaignStats](interfaces/CampaignStats.md)
- [CampaignInfo](interfaces/CampaignInfo.md)
- [PerformanceMetrics](interfaces/PerformanceMetrics.md)
- [ContributionRecord](interfaces/ContributionRecord.md)
- [MatchingConfig](interfaces/MatchingConfig.md)
...
- [STROOPS\_PER\_XLM](variables/STROOPS_PER_XLM.md)

## Functions

- [parseAndThrow](functions/parseAndThrow.md)
- [xlmToStroops](functions/xlmToStroops.md)
- [stroopsToXlm](functions/stroopsToXlm.md)
- [bpsToPercent](functions/bpsToPercent.md)
- [unixToDate](functions/unixToDate.md)
- [daysUntil](functions/daysUntil.md)
